...
> ⚠️ **Antes de tocar nada, lee [`docs/known-issues-and-security.md`](docs/known-issues-and-security.md).**
> El repo es público y actualmente tiene credenciales reales expuestas en `.env` y en el propio
> código fuente. Es el primer punto que hay que resolver.
